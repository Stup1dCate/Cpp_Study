...
int main() {
    LinkedList myList;
    int n, x, y, m;
    cout<<"Nhap so luong phan tu co trong danh sach: "; cin>>n;
	for (int i = 0; i < n; i++) {
	    int value;
	    cout<<"Nhap phan tu thu "<<i+1<<": "; cin>>value;
	    myList.insert(value);
	}
    
	cout<<"Nhap gia tri phan tu can kiem tra: "; cin>>x;
    cout<<"So phan tu trong danh sach co gia tri bang "<< x <<" la: "<<myList.countOccurrences(x)<<" phan tu"<<endl;	
	cout<<"Nhap gia tri phan tu can xoa: "; cin>>y;
    myList.deleteValue(y);
	
	
    myList.sort();
    Node *current = myList.getHead();
	    cout << "Danh sach sau khi xoa va sap xep lai theo thu tu tang dan: ";
		    while (current) {
		        cout << current->data << " ";
		        current = current->next;
		    }
	...
	cout << "Nhap so luong phan tu can them vao danh sach: "; cin>> m;
	...
	Node *current1 = myList.getHead(); 
		cout << "Danh sach sau khi chen them phan tu va sap xep: ";
			while (current1) {
			    cout << current1->data << " ";
    ...
    current = myList.getHead();
	    cout << "Danh sach moi sau khi dao nguoc co dang: ";
		    while (current) {
		        cout << current->data << " ";
		        current = current->next;
		    }
